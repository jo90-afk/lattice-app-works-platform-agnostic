...
- Added a contradictory-information scenario proving a newly linked material contradiction reactivates/contests truth, clears previously accepted truth versions, invalidates the dependent satisfied condition, increments its state version, and re-derives owner work without accepting the milestone.

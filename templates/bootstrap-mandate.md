...
- register one active objective and the first bounded milestone through the guarded runtime;
- identify open decisions and dependencies; and
- record only the minimum readiness conditions needed to make that milestone true.
...
- use the Assurance Governor to accept milestones after readiness predicates pass;
...
The Principal confirms this bootstrap mandate once for this project. Reconfirmation is required only if this project's mandate changes. This mandate does not modify the agency charter or another project, and it does not authorize a speculative backlog.
